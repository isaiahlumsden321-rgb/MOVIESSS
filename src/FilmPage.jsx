  ...
  return (
    <>
      <div className="flex justify-center items-center bg-violet-200/100 bg-center bg-cover  bg-full w-full min-h-screen">
        <div className="grid border-2 border-amber-100 w-[100%] rounded-none h-[100dvh] sm:w-[1000px] sm:h-[300px] sm:rounded-2xl grid-cols-3 grid-rows-3">
          {" "}
          ...
          <img
            src={movie.Poster}
            alt={movie.Title}
            className=" object-contain  w-auto max-h-full sm:h-[230px] sm:ml-[50px] sm:mt-[30px] rounded-2xl row-start-3 col-start-2 sm:row-start-1 sm:row-end-2 sm:col-start-1 sm:col-end-2"
          />
        </div>
      </div>{" "}
    </>
